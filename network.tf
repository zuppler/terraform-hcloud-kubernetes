locals {
  ...
  hcloud_network_id = coalesce(var.hcloud_network_id, hcloud_network.this[0].id)
  ...
  # Network ranges
  network_ipv4_cidr   = can(data.hcloud_network.this[0]) ? data.hcloud_network.this[0].ip_range : var.network_ipv4_cidr
